<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 fixed-start"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'attendance-list') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'attendance-list']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin-activity-list') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{  str_contains(request()->url(), 'ngo-list') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'ngo-list']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
