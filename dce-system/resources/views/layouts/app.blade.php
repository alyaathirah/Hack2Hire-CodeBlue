...
<body class="{{ $class ?? '' }}">
    ...
    @auth
        @if (in_array(request()->route()->getName(), ['sign-in-static', 'sign-up-static', 'login', 'register', 'recover-password', 'rtl', 'virtual-reality']))
            @yield('content')
        @else
            @if (!in_array(request()->route()->getName(), ['profile', 'profile-static', 'welcome', 'activity-list', 'register-activity', 'my-ticket', 'announcement', 'register-dependant', 'register-event', 'payment-page', 'register-event-post', 'home']))
