...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'NGO List'])
          ...
          <div class="dds__card__content">
            <div class="dds__card__header">
              <span class="dds__card__header__text">
                <h5 class="dds__card__header__title">NGO List</h5>
              </span>
              
              <button type="button" class="dds__button" data-bs-toggle="modal" data-bs-target="#ngoModal">
                <i class="dds__icon dds__icon--accessibility dds__card__header__iconn"></i>
                &nbsp&nbspAdd New NGO
              </button>
            </div>
    ...
    <!-- Add Modal -->
    <div class="dds__modal modal-dialog-scrollable" id="ngoModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 0.125rem">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="ngoModalLabel">Add New NGO</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>  
          </div>
          <div class="modal-body">
            <form data-dds="form" class="dds__form dds__container p-1 mb-0" method="POST" action="{{url('add-ngo')}}">
              @csrf
              @method('POST')
              ...
              <div class="modal-footer">
                <button type="button" class="dds__button dds__button--secondary dds__button--md" data-bs-dismiss="modal" data-bs-target="#ngoModal">Cancel</button>
                <button type="submit" class="dds__button dds__button--md">Add NGO</button>
              </div>
            </form>
          </div>
        </div>
...
<script>
  window.onload=function(){
    const myModalEl = document.getElementById('ngoModal')
